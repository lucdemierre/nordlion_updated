    ...
    const vehicles = await Vehicle.bulkCreate([
      {
        ...
        description: 'The 296 GTB redefines the concept of driving pleasure with its V6 hybrid powertrain.',
        location: 'London, UK',
        views: 1247,
        featured: true,
      },
      {
        ...
        description: 'The first super sports V12 hybrid plug-in HPEV. Revolutionary performance.',
        location: 'London, UK',
        views: 2145,
        featured: true,
      },
      ...
      },
      {
        ...
        description: 'The first fully electric Rolls-Royce. Ultra-luxury redefined.',
        location: 'London, UK',
        views: 2341,
        featured: true,
      },
      ...
      },
      {
        ...
        description: 'The pinnacle of automotive engineering. 1600hp of pure hypercar perfection.',
        location: 'London, UK',
        views: 8934,
        featured: true,
      },
      {
        ...
        description: 'Automotive art. Hand-crafted perfection with only 40 units worldwide.',
        location: 'London, UK',
        views: 12456,
        featured: true,
      },
