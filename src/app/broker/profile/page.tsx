...
import { User, Mail, Phone, MapPin, Calendar, DollarSign, TrendingUp, Users, Package } from 'lucide-react'
      ...
      <div className="flex-1 ml-16 overflow-auto">
        <header className="border-b border-white/5 bg-[#0a0a0a]/80 backdrop-blur-xl sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-6 py-6">
            ...
            <p className="text-sm text-white/50 font-light mt-1">Manage your broker account</p>
          </div>
        </header>
        ...
        <main className="max-w-4xl mx-auto px-6 py-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  <div className="px-3 py-1 bg-[#D67C3C]/10 rounded-full border border-[#D67C3C]/20">
                    <span className="text-xs text-[#D67C3C] font-medium">Elite Broker</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {[
              ...
              { icon: Package, label: 'Sales', value: '18', color: 'bg-blue-500' },
              { icon: DollarSign, label: 'Commission', value: '$145K', color: 'bg-green-500' },
              { icon: TrendingUp, label: 'Growth', value: '+23%', color: 'bg-purple-500' },
            ].map((stat, i) => {
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white font-light">+44 20 8765 4321</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-xs text-white/40 font-light">Broker Since</p>
                  <p className="text-sm text-white font-light">November 2025</p>
                </div>
              </div>
            </div>
          </div>
