  ...
  return (
    <DashboardLayout>
      <div className="h-screen flex flex-col">
        {/* Page Header */}
        <div className="h-16 px-6 border-b border-white/5 flex items-center bg-[#0f0f0f]">
            ...
            <div className="p-4 border-t border-white/5">
              <div className="flex items-end gap-3">
                ...
                <button
                  ...
                  className="p-3 bg-[#D67C3C] hover:bg-[#B85A1F] rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
